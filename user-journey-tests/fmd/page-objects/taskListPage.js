...
class TaskListPage extends Page {
  ...
  get disposalOfTheAnimalLink() {
    return $('aria/Disposal of the animal')
  }

  get slaughterInformationLink() {
    return $('aria/Slaughter information')
  }
  ...
  async selectDisposalLink(nextPage) {
    await page.selectElement(this.disposalOfTheAnimalLink)
    await page.waitForPagePath(nextPage.pagePath)
  }

  async selectSlaughterInfo(nextPage) {
    await page.selectElement(this.slaughterInformationLink)
    await page.waitForPagePath(nextPage.pagePath)
  }
