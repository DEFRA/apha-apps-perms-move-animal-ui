...
import * as page from './page-helpers.js'
import { secureDeviceArray } from './constants.js'
...
class Page {
  ...
  async verifySummaryErrorLink(linkElement, fieldElement) {
    ...
    await browser.waitUntil(async () => await fieldElement.isFocused(), {
      timeoutMsg: `Expected summary error link to focus ${await fieldElement.selector}`
    })
  }
