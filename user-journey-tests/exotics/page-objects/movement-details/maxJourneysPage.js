...
const pageHeadingAndTitle = 'What is the maximum number of journeys you need to move the animals?'
...
class MaxJourneyPage extends SingleTextInputPage {
  ...
  constructor() {
    super({
      ...
      noInputError: 'Enter the maximum number of journeys you need to move the animals',
