...
import { FmdActionableExitPageController } from '../../actionable-exit-page-controller.js'

export class CphNeededPage extends ActionableExitPage {
  urlPath = '/fmd/movement-destination/cph-needed'
  pageTitle = `You need the destination's CPH number to continue your application`
  view = `fmd/destination/cph-needed/index`
  key = 'cphNeeded'
 ...
 */
export const cphNeeded = new FmdActionableExitPageController(cphNeededPage, {
  methods: ['GET', 'POST']
}).plugin()
