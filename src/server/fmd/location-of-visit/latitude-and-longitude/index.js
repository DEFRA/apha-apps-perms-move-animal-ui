...
export class LatitudeAndLongitudePage extends QuestionPage {
  view = 'fmd/common/templates/latitude-and-longitude/index.njk'

  get heading() {
    return customHeading
  }

  urlPath = '/fmd/location-of-visit/location-details'
...
export const latitudeAndLongitude = new FmdQuestionPageController(
