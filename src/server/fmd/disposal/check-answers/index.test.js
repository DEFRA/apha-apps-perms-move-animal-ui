...
describe('CheckAnswersPage', () => {
  ...
  it('should have the expected section key', () => {
    expect(page.sectionKey).toBe('disposal')
  })

  it('should have the expected page url path', () => {
    expect(page.urlPath).toBe('/fmd/disposal-of-the-animal/check-answers')
  })

  it('should return the right section', () => {
    expect(page.sectionFactory({})).toBeInstanceOf(DisposalSection)
  })

  it('should have a url key of', () => {
    expect(page.urlKey).toBe('fmd/disposal-of-the-animal')
  })
