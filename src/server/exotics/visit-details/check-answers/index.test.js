...
describe('CheckAnswersPage', () => {
  ...
  it('should have the expected section key', () => {
    expect(page.sectionKey).toBe('visitDetails')
  })

  it('should have the expected page url path', () => {
    expect(page.urlPath).toBe('/exotics/visit-details/check-answers')
  })

  it('should return the right section', () => {
    expect(page.sectionFactory({})).toBeInstanceOf(VisitDetailsSection)
  })

  it('should have a url key of', () => {
    expect(page.urlKey).toBe('exotics/visit-details')
  })
