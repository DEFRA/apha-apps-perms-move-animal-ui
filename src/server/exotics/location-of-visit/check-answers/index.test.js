...
describe('CheckAnswersPage', () => {
  ...
  it('should have the expected section key', () => {
    expect(page.sectionKey).toBe('locationOfVisit')
  })

  it('should have the expected page url path', () => {
    expect(page.urlPath).toBe('/exotics/location-of-visit/check-answers')
  })

  it('should return the right section', () => {
    expect(page.sectionFactory({})).toBeInstanceOf(LocationOfVisitSection)
  })

  it('should have a url key of', () => {
    expect(page.urlKey).toBe('exotics/location-of-visit')
  })
